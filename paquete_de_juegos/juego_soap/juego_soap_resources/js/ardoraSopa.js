...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"juego_soap_resources/media/i1_Prot__n-Estructura_de_Quarks.png","");
...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"juego_soap_resources/media/i2_descarga.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
